...
for int_i in range(8, 50, 8):
    frequencies100_sim = []
    i = int_i / 10000
    file_name = "PSD_" + str(i) + '.txt'
    with open(os.path.join(os.getcwd(), 'inletPG3_Graphs', file_name), 'r') as psd_data:
    ...
    i_label = 'Simulated of $\lambda$ =' + str(i_lambda)
    lns2 = ax.semilogx(particle_sizes, frequencies100_sim, 'o--', linewidth=2, label=i_label)
