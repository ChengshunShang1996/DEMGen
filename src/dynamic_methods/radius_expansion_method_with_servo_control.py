...
class RadiusExpansionMethodWithServoControl(DynamicMethod):
    ...
    def Run(self, parameters, ini_path):
        ...
        target_packing_density_list = [target_packing_density-0.002, target_packing_density-0.002, target_packing_density-0.05, target_packing_density-0.075, target_packing_density-0.1, target_packing_density-0.15]
        self.packing_cnt = 1
